...
export const DEFAULT_MAX_SAFE_TAG_WRITE_FILE_BYTES = 100 * 1024 * 1024;
...
const writeU32 = (b: Uint8Array, o: number, value: number): void => {
  b[o] = (value >>> 24) & 0xff;
  b[o + 1] = (value >>> 16) & 0xff;
  b[o + 2] = (value >>> 8) & 0xff;
  b[o + 3] = value & 0xff;
...
const withUriWriteLock = async <T>(
  uri: string,
  operation: () => Promise<T>,
): Promise<T> => {
